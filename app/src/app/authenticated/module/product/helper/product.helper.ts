...
class ProductHelper implements Helper<Product, ProductDto, ProductDetailFormConfig> {
    ...
    formConfigToCreatePayload(detailFormConfig: ProductDetailFormConfig): ProductCreatePayload {
        return {
            ...
            complement: '',
            hook: '',
            position: detailFormConfig.position.formControl.value,
    ...
    toDetailConfig(business: Product): ProductDetailFormConfig {
        const formGroup = new FormGroup({
            ...
            position: new FormControl(business.position)
        });
        ...
        return {
            ...
            position: {
                ...
                type: 'text',
                translateKey: translateKey,
                formControl: (formGroup.get('position')!) as unknown as FormControl
            }

        }
    }

    orderToProductProduction(orders: Order[]): ProductProductionGroup[] {
        return ProductOptionHelper.getUniqueProductOption(orders);
    }
}
